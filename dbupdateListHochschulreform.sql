...
CREATE TABLE IF NOT EXISTS `paper2appearance` (
	  `paper_id` int(11) NOT NULL,
	  `appearance_id` int(11) NOT NULL,
	  KEY `paper_id` (`paper_id`,`appearance_id`)
	) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `paper2dominance` (
	  `paper_id` int(11) NOT NULL,
	  `dominance_id` int(11) NOT NULL,
	  KEY `paper_id` (`paper_id`,`dominance_id`)
	) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO paper2appearance (paper_id,appearance_id) SELECT paper.id,paper.appearance_id FROM paper;
INSERT INTO paper2dominance (paper_id,dominance_id) SELECT paper.id,paper.dominance_id FROM paper;
